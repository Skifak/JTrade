    ...
    <section id="about" class="guide-section hero">
      ...
      <div class="hero-grid">
        ...
        <div class="hero-card">
          ...
          <p>KPI и heatmaps во вкладке «Статистика»; «Аналитика» — маяки, дорожная карта, советы из локальной базы, фокус недели с прогрессом и сравнение недель.</p>
        </div>
      </div>
    </section>
...
# Это комментарий — игнорируется</pre>
    ...
    <section id="analytics" class="guide-section">
      ...
      <p class="lead">
        ...
        короткие советы из встроенной локальной базы (без облака и без LLM), сравнение недель и привязка дневника к результату.
      </p>
